...
bool ImGui_ImplMetal_CreateFontsTexture(id<MTLDevice> device)
{
    ...
    io.Fonts->SetTexID((ImTextureID)(__bridge void *)bd->SharedMetalContext.fontTexture); // Explicit cast to ImTextureID
    return true;
}
...
void ImGui_ImplMetal_DestroyFontsTexture()
{
    ...
    io.Fonts->SetTexID(0);  // or (ImTextureID)0
}
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                if (ImTextureID tex_id = pcmd->GetTexID())
                    [commandEncoder setFragmentTexture:(__bridge id<MTLTexture>)(void*)tex_id atIndex:0];
